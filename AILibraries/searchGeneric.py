...
from AILibraries.display import Displayable, visualize
...
from AILibraries.searchProblem import Path
...
import AILibraries.searchProblem as searchProblem
...
# searcher2 = AStarSearcher(searchProblem.simp_delivery_graph)   # A*
# searcher2.search()  # find first path
# searcher2.search()  # find next path
# searcher3 = Searcher(searchProblem.cyclic_simp_delivery_graph)   # DFS
