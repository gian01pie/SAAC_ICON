...
from AILibraries.searchGeneric import AStarSearcher, visualize
...
# from AILibraries.searchGeneric import test
# if __name__ == "__main__":
#     test(SearcherMPP)

import AILibraries.searchProblem
# searcherMPPcdp = SearcherMPP(searchProblem.cyclic_simp_delivery_graph)
